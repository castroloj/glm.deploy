...
test_that("Multiple family regression and link functions work",{
  ...
  file.remove("Binomial_logit.h")
  file.remove("Binomial_probit.h")
  file.remove("Binomial_cloglog.h")
  file.remove("Gaussian_identity.h")
  file.remove("Poisson_log.h")
  file.remove("Poisson_identity.h")
  file.remove("Poisson_sqrt.h")
  file.remove("quasi_identity.h")
  file.remove("Gamma_identity.h")
  file.remove("Gamma_log.h")
  file.remove("Gamma_inverse.h")
  file.remove("InverseGaussian_mu.h")
