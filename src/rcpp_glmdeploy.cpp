...
void glmdeploy_cpp(DataFrame dataFields,
  ...
  filecontents.push_back("/*This file was generated by the glm.deploy R package v1.0.0*/");
  filecontents.push_back("/*Thanks for using our tool which is free under the GPL3.0, please cite the package or put a link to our project.*/");
  filecontents.push_back(getMultiHeader(lang,filename));
  filecontents.push_back(getFunctionDeclaration(lang,functionName,arguments));
  ...
  filecontents.push_back(getFunctionDeclaration(lang,functionName+"_response",arguments));
  ...
  if(filename.empty())
    filename = "glm_"+ functionName;
  switch(lang){
  case CANSI:
    filecontents.push_back(getMultiFooter(lang));
    saveFile(filename + ".c", filecontents);
    Rcout << "File saved: " << filename + ".c" <<"\n";
    break;
  case JAVA:
    ...
    filecontents.push_back(getMultiFooter(lang));
    saveFile(filename + "_class.java", filecontents);
    Rcout << "File saved: " << filename + "_class.java" <<"\n";
    break;
  default:
    break;
  }
...
std::string getResponseFunction(outlang lang,
  ...
  std::string funcall = "glm_" + functionName + "(" + functionArguments + ")";
